  ...
  const comparisonFeatures = [
    {
      ...
      features: [
        { name: 'Monthly Operations', starter: '40', team: '200', scale: '800', enterprise: '3,000+' },
        { name: 'Cost per Operation', starter: '$0.73', team: '$0.40', scale: '$0.25', enterprise: '<$0.20' },
        { name: 'Overage Pricing', starter: '$0.50/op', team: '$0.50/op', scale: '$0.50/op', enterprise: 'Custom' }
      ]
    },
    {
      category: 'Frameworks & Analysis',
      features: [
        { name: 'Basic Frameworks (ICE, RICE)', starter: '✓', team: '✓', scale: '✓', enterprise: '✓' },
        { name: 'Advanced Frameworks', starter: '✗', team: '✓', scale: '✓', enterprise: '✓' },
        { name: 'Custom Frameworks', starter: '✗', team: '✗', scale: 'Limited', enterprise: '✓' },
        { name: 'Competitive Intelligence', starter: 'Basic', team: '✓', scale: 'Advanced', enterprise: 'Custom' }
      ]
    },
    {
      category: 'Team & Collaboration',
      features: [
        { name: 'PM Workspaces', starter: '1', team: '5', scale: '15', enterprise: 'Unlimited' },
        { name: 'Team Collaboration', starter: '✗', team: '✓', scale: '✓', enterprise: '✓' },
        { name: 'Advanced Workflows', starter: '✗', team: 'Basic', scale: '✓', enterprise: 'Custom' }
      ]
    },
    {
      category: 'Support & Training',
      features: [
        { name: 'Support Level', starter: 'Email', team: 'Priority', scale: 'Dedicated', enterprise: '24/7 Phone' },
        { name: 'Onboarding', starter: 'Self-service', team: 'Guided', scale: 'White-glove', enterprise: 'Executive' },
        { name: 'Training Program', starter: '✗', team: 'Online', scale: 'Live Sessions', enterprise: 'Custom Program' }
      ]
    }
  ];
                  ...
                  <Table highlightOnHover>
                    <Table.Thead>
                      <Table.Tr>
                        ...
                        <Table.Th ta="center" style={{ backgroundColor: 'var(--mantine-color-indigo-0)' }}>
                          Team
                          <Badge size="xs" color="indigo" variant="filled" ml={8}>Popular</Badge>
                        </Table.Th>
                        <Table.Th ta="center">Scale</Table.Th>
                    ...
                    <Table.Tbody>
                      {comparisonFeatures.map((category, categoryIndex) => (
                        <React.Fragment key={categoryIndex}>
                          <Table.Tr>
                            <Table.Td colSpan={5}>
                              <Text fw={700} size="lg" c="indigo.6" py={8}>
                                {category.category}
                              </Text>
                            </Table.Td>
                          </Table.Tr>
                          {category.features.map((feature, featureIndex) => (
                            <Table.Tr key={featureIndex}>
                              <Table.Td>
                                <Text fw={500}>{feature.name}</Text>
                              </Table.Td>
                              <Table.Td ta="center">
                                <Text size="sm">{feature.starter}</Text>
                              </Table.Td>
                              <Table.Td ta="center" style={{ backgroundColor: 'var(--mantine-color-indigo-0)' }}>
                                <Text size="sm" fw={600}>{feature.team}</Text>
                              </Table.Td>
                              <Table.Td ta="center">
                                <Text size="sm">{feature.scale}</Text>
                              </Table.Td>
                              <Table.Td ta="center">
                                <Text size="sm">{feature.enterprise}</Text>
                              </Table.Td>
                            </Table.Tr>
                          ))}
                        </React.Fragment>
